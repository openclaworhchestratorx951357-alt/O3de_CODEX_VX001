...
export const appAuditReviewDashboardRows: readonly AppAuditReviewRow[] = [
  ...
  },
  {
    ...
    nextGate: "validation intake endpoint-candidate admission design",
  },
  {
    domain: "GUI",
    capabilityWindow: "capability + audit + evidence + approval/session + workspace-status shells",
    currentMaturity: "GUI/demo only",
    statusTaxonomy: "demo",
    risk: "Medium",
    gateStatus: "cross-shell truth labels aligned",
    verdict: "pass",
    findings: "Static-fixture shell surfaces now exist for capability, audit, evidence, approval/session, and workspace-status truth visibility.",
    nextGate: "validation intake endpoint-candidate admission design",
  },
  {
    domain: "Automation",
