...
const s = {
  ...
  topMenu: { display: "flex", alignItems: "center", gap: 4, minWidth: 0, padding: "0 8px", borderBottom: "1px solid #27384b", background: "#101820", overflowX: "auto", overflowY: "hidden", height: 34 },
  ...
  truthStrip: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(120px, 1fr))", gap: 6, alignItems: "center", minWidth: 0, padding: "4px 8px", borderBottom: "1px solid #27384b", background: "#0e151f", overflow: "hidden" },
  ...
  toolShelf: { display: "grid", alignContent: "start", gap: 4, width: 64, minWidth: 64, maxWidth: 64, minHeight: 0, overflowY: "auto", overflowX: "hidden", border: "1px solid #2b3e55", borderRadius: 5, padding: "5px 2px", background: "#111923" },
  toolButton: { display: "grid", justifyItems: "center", alignContent: "center", gap: 2, minHeight: 32, border: "1px solid #2f4054", borderRadius: 4, background: "#17212d", color: "#d6e2ee", fontSize: 10, fontWeight: 900, cursor: "pointer", padding: "3px 0", overflow: "hidden", lineHeight: 1 },
  activeToolButton: { display: "grid", justifyItems: "center", alignContent: "center", gap: 2, minHeight: 32, border: "1px solid #5aa9ff", borderRadius: 4, background: "#183f63", color: "#d6e2ee", fontSize: 10, fontWeight: 900, cursor: "pointer", padding: "3px 0", overflow: "hidden", lineHeight: 1 },
  ...
  viewport: { position: "relative", minHeight: 360, height: "100%", overflow: "hidden", border: "1px solid #35506e", borderRadius: 5, background: "linear-gradient(180deg, #0d2740 0%, #071019 58%, #05080d 100%)" },
