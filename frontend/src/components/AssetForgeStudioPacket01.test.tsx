...
describe("AssetForgeStudioPacket01", () => {
  ...
  it("creates Packet 09.5 operator review packet and renders review details", async () => {
    ...
    expect(screen.getByText(/Commercial use allowed: yes/i)).toBeInTheDocument();
    ...
    expect(screen.getByText(/Asset processor completed: yes/i)).toBeInTheDocument();
  ...
  it("renders runtime-harness readiness bridge requirement as unknown when contract boolean is absent", async () => {
    apiMocks.createAssetForgeO3DEPlacementPlan.mockResolvedValueOnce(makePlacementPlanReport());
    apiMocks.prepareAssetForgeO3DEPlacementRuntimeHarness.mockResolvedValueOnce(
      makePlacementHarnessReport({
        bridge_readiness_contract: {
          corridor_name: "asset_forge.o3de.placement.runtime_harness.v1",
          runtime_gate_env: "ASSET_FORGE_ENABLE_PLACEMENT_RUNTIME_HARNESS",
          bridge_required: undefined as unknown as boolean,
        },
      }),
    );
  ...
  it("renders runtime-harness execute bridge requirement as unknown when contract boolean is absent", async () => {
    apiMocks.createAssetForgeO3DEPlacementPlan.mockResolvedValueOnce(makePlacementPlanReport());
  ...
  it("renders runtime-harness approval string summaries as n/a when optional fields are absent", async () => {
    apiMocks.createAssetForgeO3DEPlacementPlan.mockResolvedValueOnce(makePlacementPlanReport());
    apiMocks.executeAssetForgeO3DEPlacementRuntimeHarness.mockResolvedValueOnce(
      makePlacementHarnessExecuteReport({
        server_approval_evaluation: {
  ...
  it("renders live-proof approval string summaries as n/a when optional fields are absent", async () => {
    apiMocks.createAssetForgeO3DEPlacementPlan.mockResolvedValueOnce(makePlacementPlanReport());
    apiMocks.executeAssetForgeO3DEPlacementLiveProof.mockResolvedValueOnce(
      makePlacementLiveProofReport({
        server_approval_evaluation: {
