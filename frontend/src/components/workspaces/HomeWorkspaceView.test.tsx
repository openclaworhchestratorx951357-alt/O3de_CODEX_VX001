...
describe("HomeWorkspaceView", () => {
  ...
  it("defaults to the calmer start-here layout and switches surfaces on demand", async () => {
    ...
    expect(await screen.findByText("Choose what you are building", undefined, { timeout: 5000 })).toBeInTheDocument();
  ...
  it("switches Home task modes into O3DE creation and project loading desks", async () => {
    ...
    const productionPlanner = await screen.findByLabelText("O3DE production planner", undefined, { timeout: 5000 });
