...
export default function DispatchForm({
  ...
  const hybridDispatchNote = hybridModeActive
    ? selectedToolMayUseRealPath
      ? "Hybrid mode is active. This tool may use the real read-only project inspection path when its manifest preconditions are satisfied, including manifest-backed project-config, Gem, and top-level settings evidence when requested; otherwise it will fall back to simulation."
        ...
        <div style={{ display: "grid", gap: 12 }}>
            ...
            >
              ...
              <div>
                ...
                {selectedCapabilityStatus === "hybrid-read-only" && selectedToolMayUseRealPath
                  ? "Possible real read-only project inspection in hybrid mode, including manifest-backed project-config, Gem, and top-level settings evidence when requested; simulated fallback remains explicit."
          ...
          {effectiveToolName === "project.inspect" ? (
            <p style={{ margin: 0, color: "#57606a" }}>
              ...
              currently supported real manifest-backed project-config, Gem, and
              top-level settings evidence in hybrid mode.
            </p>
          ) : null}
