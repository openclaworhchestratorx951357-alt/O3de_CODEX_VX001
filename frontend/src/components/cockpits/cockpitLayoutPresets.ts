...
const presetDefinitions: Record<CockpitLayoutPresetId, CockpitLayoutPresetDefinition> = {
  "app-os-cockpit": {
    ...
    sizes: {
      leftPrimaryRatio: 0.25,
      centerPrimaryRatio: 0.74,
      topPrimaryRatio: 0.8,
    },
  ...
  "home-launcher": {
    ...
    sizes: {
      ...
      centerPrimaryRatio: 0.76,
      topPrimaryRatio: 0.82,
    },
    placePanel: (panel) => panel.defaultZone,
  },
  "create-game-cockpit": {
