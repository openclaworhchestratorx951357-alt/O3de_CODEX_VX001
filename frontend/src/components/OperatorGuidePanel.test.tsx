...
describe("OperatorGuidePanel", () => {
  it("renders capability posture and workspace guidance from the shared catalog", () => {
    ...
    expect(
      screen.getByText(
        /Admitted real: editor\.session\.open, editor\.level\.open, editor\.entity\.create, editor\.entity\.exists, editor\.component\.add, editor\.component\.property\.get/i,
      ),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
    ...
    expect(screen.getByText(".\\scripts\\dev.ps1 live-proof")).toBeInTheDocument();
