...
| Validation | `validation.report.intake` | needs baseline | read-only | Medium | schema + provenance gate | parser tests + malformed-input fail-closed tests | Validation intake contract + fail-closed parser design |
