...
- `docs/GUI-SHELL-TAXONOMY-PARITY-CHECKPOINT-QUICK-REFERENCE-REFRESH-PACKET.md`
- `docs/APP-CAPABILITY-DASHBOARD-SHELL.md`
- `docs/APP-CAPABILITY-DASHBOARD-TRUTH-REFRESH-STATUS-CHIP-LINKAGE.md`
- `docs/APP-CAPABILITY-DASHBOARD-TRUTH-REFRESH-STATUS-CHIP-LINKAGE-PACKET.md`
...
- `docs/WORKSPACE-STATUS-CHIPS-SHELL-TRUTH-TAXONOMY-LINKAGE-PACKET.md`
...
- `docs/APP-EVIDENCE-TIMELINE-SHELL.md`
- `docs/APP-APPROVAL-SESSION-DASHBOARD-SHELL.md`
- `docs/APP-WORKSPACE-STATUS-CHIPS-SHELL.md`
