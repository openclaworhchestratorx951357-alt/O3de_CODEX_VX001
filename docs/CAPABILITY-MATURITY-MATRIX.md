...
| `editor.component.property.write` | M1 public contract/candidate only | `docs/PHASE-8-EDITOR-COMPONENT-PROPERTY-WRITE-CANDIDATE.md`, `docs/PHASE-8-CAMERA-SCALAR-WRITE-CANDIDATE-DESIGN.md`, `docs/PHASE-8-CAMERA-SCALAR-WRITE-LIVE-PROOF.md` | Public property-write remains refused/unimplemented. The Camera bool proof is a proof-only bridge/runtime harness, not a generalized or public property-write surface. |
