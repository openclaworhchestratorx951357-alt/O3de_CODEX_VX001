...
| `ai.asset.import.stage` | M1 design-only | `docs/AI-ASSET-FORGE-PRODUCTION-ROADMAP.md`, `docs/AI-ASSET-FORGE-O3DE-IMPORT-READINESS-DESIGN.md` | Future staging corridor is designed with generated-asset folder, provenance, approval, and Phase 9 readback requirements. No O3DE project mutation, generated source asset import, Asset Processor execution, or staging folder write is admitted yet. |
