...
| `asset.source.inspect` | M5 real but narrow; project-general proof-only readback candidate | surface matrix, Phase 9 proof docs, `docs/PHASE-9-PRODUCTION-GENERALIZATION-PLAN.md`, `docs/PHASE-9-PROJECT-ASSET-READBACK-DISCOVERY.md`, `docs/PHASE-9-PROJECT-GENERAL-ASSET-SOURCE-INSPECT-PROOF.md` | Narrow project-local source metadata plus bounded read-only `Cache/assetdb.sqlite` product/dependency evidence and Asset Catalog product-path presence for one explicit source asset. The adapter now uses project-general discovery inputs and fails closed for missing project/cache/catalog/source conditions. Schema hardening and public production-general admission are still pending. |
...
| `ai.asset.o3de.readback.verify` | M2 depends on Phase 9 schema hardening/admission | `docs/PHASE-9-AI-ASSET-FORGE-INTEGRATION.md`, `docs/PHASE-9-PROJECT-ASSET-READBACK-DISCOVERY.md`, `docs/PHASE-9-PROJECT-GENERAL-ASSET-SOURCE-INSPECT-PROOF.md` | Future generated assets must use Phase 9 source/product/dependency/catalog readback. Project-general proof-only `asset.source.inspect` integration now exists; schema hardening and public admission remain pending. |
