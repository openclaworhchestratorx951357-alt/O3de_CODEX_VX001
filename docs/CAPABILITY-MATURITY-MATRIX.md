...
| `asset.source.inspect` | M5 real but narrow; project-general proof-only readback candidate with structured schema and review contract | surface matrix, Phase 9 proof docs, `docs/PHASE-9-PRODUCTION-GENERALIZATION-PLAN.md`, `docs/PHASE-9-PROJECT-ASSET-READBACK-DISCOVERY.md`, `docs/PHASE-9-PROJECT-GENERAL-ASSET-SOURCE-INSPECT-PROOF.md`, `docs/PHASE-9-ASSET-SOURCE-INSPECT-SCHEMA-HARDENING.md`, `docs/PHASE-9-ASSET-READBACK-ADMISSION-DECISION.md`, `docs/PHASE-9-ASSET-READBACK-READINESS-REVIEW-CONTRACT.md` | Narrow project-local source metadata plus bounded read-only `Cache/assetdb.sqlite` product/dependency evidence and Asset Catalog product-path presence for one explicit source asset. The adapter now uses project-general discovery inputs, fails closed for missing project/cache/catalog/source conditions, and has published structured proof schema fields plus an operator-facing review contract. Public production-general admission is withheld until that review packet is implemented with freshness, platform, missing-substrate guidance, mutation flags, and safest-next-step output. |
| `ai.asset.generate.local` | M1 planned/design only | `docs/AI-ASSET-FORGE-PRODUCTION-ROADMAP.md` | Planned private/local generation stream for O3DE AI Asset Forge. No model backend selected, no model download, no dependency added, and no generated asset exists in repo. |
| `ai.asset.cleanup.convert` | M1 planned/design only | `docs/AI-ASSET-FORGE-PRODUCTION-ROADMAP.md`, `docs/AI-ASSET-FORGE-O3DE-INTEGRATION-ARCHITECTURE.md` | Planned cleanup/conversion layer, likely using Blender automation after audit. No conversion proof or generated asset output is admitted. |
| `ai.asset.import.stage` | M0/M1 missing/planned | `docs/AI-ASSET-FORGE-PRODUCTION-ROADMAP.md` | Future staging corridor only. No O3DE project mutation, generated source asset import, or staging folder write is admitted. |
...
| `ai.asset.o3de.readback.verify` | M2 depends on Phase 9 review packet implementation | `docs/PHASE-9-AI-ASSET-FORGE-INTEGRATION.md`, `docs/PHASE-9-PROJECT-ASSET-READBACK-DISCOVERY.md`, `docs/PHASE-9-PROJECT-GENERAL-ASSET-SOURCE-INSPECT-PROOF.md`, `docs/PHASE-9-ASSET-SOURCE-INSPECT-SCHEMA-HARDENING.md`, `docs/PHASE-9-ASSET-READBACK-ADMISSION-DECISION.md`, `docs/PHASE-9-ASSET-READBACK-READINESS-REVIEW-CONTRACT.md` | Future generated assets must use Phase 9 source/product/dependency/catalog readback. Project-general proof-only `asset.source.inspect` integration, structured schemas, and a review contract now exist; production-general verification is withheld until runtime/operator output carries freshness, platform, provenance handoff, mutation flags, and operator approval state. |
| `ai.asset.operator.review` | M1 planned | `docs/AI-ASSET-FORGE-O3DE-INTEGRATION-ARCHITECTURE.md` | Operator review packet is required before generated asset use, but no UI/backend review implementation exists. |
