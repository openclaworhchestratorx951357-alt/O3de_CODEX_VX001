...
| `asset.source.inspect` | M5 real but narrow; project-general proof-only readback candidate with structured schema | surface matrix, Phase 9 proof docs, `docs/PHASE-9-PRODUCTION-GENERALIZATION-PLAN.md`, `docs/PHASE-9-PROJECT-ASSET-READBACK-DISCOVERY.md`, `docs/PHASE-9-PROJECT-GENERAL-ASSET-SOURCE-INSPECT-PROOF.md`, `docs/PHASE-9-ASSET-SOURCE-INSPECT-SCHEMA-HARDENING.md` | Narrow project-local source metadata plus bounded read-only `Cache/assetdb.sqlite` product/dependency evidence and Asset Catalog product-path presence for one explicit source asset. The adapter now uses project-general discovery inputs, fails closed for missing project/cache/catalog/source conditions, and has published structured proof schema fields. Public production-general admission is still pending. |
...
| `ai.asset.o3de.readback.verify` | M2 depends on Phase 9 public admission decision | `docs/PHASE-9-AI-ASSET-FORGE-INTEGRATION.md`, `docs/PHASE-9-PROJECT-ASSET-READBACK-DISCOVERY.md`, `docs/PHASE-9-PROJECT-GENERAL-ASSET-SOURCE-INSPECT-PROOF.md`, `docs/PHASE-9-ASSET-SOURCE-INSPECT-SCHEMA-HARDENING.md` | Future generated assets must use Phase 9 source/product/dependency/catalog readback. Project-general proof-only `asset.source.inspect` integration and structured schemas now exist; public admission remains pending. |
